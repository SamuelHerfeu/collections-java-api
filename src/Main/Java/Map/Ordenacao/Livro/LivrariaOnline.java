package Main.Java.Map.Ordenacao.Livro;
...
public class LivrariaOnline {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Main.Java.Map.Ordenacao.Livro.Livro mais caro: " + livrariaOnline.obterLivroMaisCaro());

        // Obtém e exibe o livro mais barato
        System.out.println("Main.Java.Map.Ordenacao.Livro.Livro mais barato: " + livrariaOnline.obterLivroMaisBarato());
